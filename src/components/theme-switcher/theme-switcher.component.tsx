...
import { switchGlobalLoaderToState } from '@/redux/common/common.reducer'
...
const ThemeSwitcher = () => {
  ...
  useEffect(() => {
    ...
    dispatch(switchGlobalLoaderToState({ state: false }))
  ...
  return (
    <label className="swap swap-rotate">
      <input type="checkbox" checked={!isDark} onChange={handleThemeSwitch} />
