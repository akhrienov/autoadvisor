...
const GlobalLoader = () => {
  ...
  return (
    <div
      className={`${
        globalLoaderActive ? '' : 'hidden'
      } absolute z-100 top-0 h-screen w-full flex justify-center items-center bg-slate-200`}
    >
      <svg
        className="fill-primary w-3/12 md:w-1/12"
      ...
      >
        ...
        <g>
          <path
            x="-136,996"
            y="-136,996"
            className={classes.mediumShadow}
